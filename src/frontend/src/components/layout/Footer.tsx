    ...
    >
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-4 group">
              <div className="w-10 h-10 rounded-full gradient-gold flex items-center justify-center shadow-luxury">
            ...
            <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
              Where every frame tells a story. Premium photography and
              videography services with cinematic excellence.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  <p className="text-sm text-foreground group-hover:text-primary transition-smooth break-all">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} RAP Integrated Studio Management. All rights
            reserved.
          </p>
          <p className="text-xs text-muted-foreground">
